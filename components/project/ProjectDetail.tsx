      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex gap-4">
            ...
            {(project.link || project.vercelLink || project.figmaLink || project.canvaLink) && (
              <a href={project.link || project.vercelLink || project.figmaLink || project.canvaLink} target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-white text-black font-black rounded-full transition-all flex items-center gap-3 shadow-2xl hover:scale-105 active:scale-95">
                <span className="text-sm uppercase tracking-widest">
                  {project.figmaLink || project.canvaLink ? "View Design" : "Live Demo"}
                </span>
